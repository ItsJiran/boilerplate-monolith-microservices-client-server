...
HOST_SOURCES[app]="${SERVICE_SERVER_DOMAIN}"
HOST_SOURCES[api]="${SERVICE_API_DOMAIN:-${SERVICE_API_URL}}"
HOST_SOURCES[s3]="${SERVICE_S3_DOMAIN:-${S3_URL}}"
HOST_SOURCES[s3-console]="${SERVICE_S3_CONSOLE_DOMAIN:-${S3_CONSOLE_URL}}"
HOST_SOURCES[grafana]="${GRAFANA_URL}"
HOST_SOURCES[pma]="${SERVICE_PMA_DOMAIN:-${SERVICE_PMA_ABSOLUTE_URI:-${PHPMYADMIN_URL}}}"
HOST_SOURCES[reverb]="${SERVICE_REVERB_DOMAIN:-${SERVICE_REVERB_URL}}"
HOST_SOURCES[hmr]="${SERVICE_HMR_URL}"
